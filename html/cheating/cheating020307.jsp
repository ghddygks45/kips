					...
					<div class="section first">
						<div class="tbl_box">
							<table class="tbl tbl_list reply">
								...
								<tbody>
									<tr>
										<td class="cell_hidden">6</td>
										<td>민원종결</td>
										<td class="txt_l"><a href="#n" class="link_txt">해당 미원은 신고접수가 종결되었습니다. 종결사유는 담당자 메모를 참고하시기 바랍니다.</a>
										</td>
									...
									<tr class="tbl_reply">
										<td>
											...
											<div class="rep_txt">
												김철수님 안녕하십니까 보내주신 민원신고서 보완이 14일 이상 지연되어 부득이 신고내용을 종결하게 되었습니다.<br>
												궁금하신 사항은 신고조사팀 홍길동(02-1234-1234)로 연락 부탁드리며<br>
												새로운 민원신고서를 작성하여 제출하실 수 있습니다.<br>감사합니다.
											</div>
											<div class="rep_file">
												<strong>첨부파일 :</strong>
												<a href="#n">첨부파일.hwp</a>
									...
									<!-- // 답변 -->
									<tr>
										<td class="cell_hidden">5</td>
										<td>조사완료</td>
										<td class="txt_l"><a href="#n" class="link_txt">해당 민원의 조사 및 조치가 완료되었습니다.</a></td>
										<td class="cell_hidden">홍길동</td>
										<td class="reply_date">2021-11-02 19:20:11</td>
									</tr>
									<!-- 답변 -->
									<tr class="tbl_reply">
										<td>
											<div class="rep_txt mb0">
												해당 민원에 대한 조사 및 조치결과는 담당자가 별도 통보 드립니다.<br>
												감사합니다.
											</div>
										</td>
									</tr>
